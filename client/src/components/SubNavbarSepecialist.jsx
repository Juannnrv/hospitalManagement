...
import AppointmentListHeaders from "./AppointmentListHeader";
import DoctorListHeader from "./DoctorListHeaders";

const SubNavbarSepecialist = () => {
  ...
  return (
    <div>
      ...
      <div className="content">
        {activeSubNav === 0 && <DoctorListHeader />}{" "}
        {activeSubNav === 1 && <AppointmentListHeaders />}{" "}
      </div>
    </div>
  );
};

export default SubNavbarSepecialist;